...
public class OriginController : ControllerBase
{
    ...
    [HttpGet(Endpoints.MetadataApi.Audit.Origin.Assert)]
    ...
    public async Task<ActionResult<int>> CountAsync([FromQuery] IOriginCriteria criteria, CancellationToken token)
    {
        var count = await _originService.CountAsync(criteria, token);
    ...
    public async Task<ActionResult<IEnumerable<OriginModel>>> CollectAsync([FromQuery] IOriginCriteria criteria, CancellationToken token)
    {
        var models = await _originService.CollectAsync(criteria, token);
    ...
    public async Task<ActionResult<IEnumerable<OriginMatch>>> SearchAsync([FromQuery] IOriginCriteria criteria, CancellationToken token)
    {
        var matches = await _originService.SearchAsync(criteria, token);
