...
public class ResourceController : ControllerBase
{
    ...
    [HttpGet(Endpoints.SecurityApi.Authorization.Resource.Assert)]
    ...
    public async Task<ActionResult<int>> CountAsync([FromQuery] IResourceCriteria criteria, CancellationToken token)
    {
        var count = await _resourceService.CountAsync(criteria, token);
    ...
    public async Task<ActionResult<IEnumerable<ResourceModel>>> CollectAsync([FromQuery] IResourceCriteria criteria, CancellationToken token)
    {
        var models = await _resourceService.CollectAsync(criteria, token);
    ...
    public async Task<ActionResult<IEnumerable<ResourceMatch>>> SearchAsync([FromQuery] IResourceCriteria criteria, CancellationToken token)
    {
        var matches = await _resourceService.SearchAsync(criteria, token);
