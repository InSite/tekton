...
public class RoleController : ControllerBase
{
    ...
    [HttpGet(Endpoints.SecurityApi.Identification.Role.Assert)]
    ...
    public async Task<ActionResult<int>> CountAsync([FromQuery] IRoleCriteria criteria, CancellationToken token)
    {
        var count = await _roleService.CountAsync(criteria, token);
    ...
    public async Task<ActionResult<IEnumerable<RoleModel>>> CollectAsync([FromQuery] IRoleCriteria criteria, CancellationToken token)
    {
        var models = await _roleService.CollectAsync(criteria, token);
    ...
    public async Task<ActionResult<IEnumerable<RoleMatch>>> SearchAsync([FromQuery] IRoleCriteria criteria, CancellationToken token)
    {
        var matches = await _roleService.SearchAsync(criteria, token);
